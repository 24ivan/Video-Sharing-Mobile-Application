        ...
        <View className="w-full flex justify-center items-center h-[85vh] px-4">
          ...
          <View className="relative mt-5">
            <Text className="text-3xl text-white font-bold text-center">Discover Endless Posibilities with   
              <Text className="text-secondary-200"> Share AI</Text>
              </Text>
              <Image
                source={images.path}
                className="w-[160px] h-[15px] absolute -bottom-2 -right-1"
                resizeMode="contain"
              />
          </View>
          
          <Text className="text-sm font-pregular text-gray-100 mt-7 text-center"> Where creativity meets innovation: embark on a journey of limitless exploration with Share AI</Text>
